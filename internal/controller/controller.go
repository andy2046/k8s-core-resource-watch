...
import (
	...
	"github.com/andy2046/k8s-core-resource-watch/internal/handler"
	...
	informer := cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metaV1.ListOptions) (runtime.Object, error) {
				// list all of the pods (core resource) in the namespace
				return client.CoreV1().Pods(nameSpace).List(options)
			},
			WatchFunc: func(options metaV1.ListOptions) (watch.Interface, error) {
				// watch all of the pods (core resource) in the namespace
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			...
			if err == nil {
				...
				logger.Printf("Add pod error: %s", err)
			}
		},
		UpdateFunc: func(oldObj, newObj interface{}) {
			...
			if err == nil {
				...
				logger.Printf("Update pod error: %s", err)
			}
		},
		DeleteFunc: func(obj interface{}) {
			...
			if err == nil {
				...
				logger.Printf("Delete pod error: %s", err)
			}
		},
	})
...
func (c *Controller) processNextItem() bool {
	...
	if !exists {
		...
		logger.Printf("Controller.processNextItem: object creation/update detected: %s", keyRaw)
